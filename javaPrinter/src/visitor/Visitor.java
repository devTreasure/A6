...
public interface Visitor {
	...
	/**
	 * f0 -> ( "abstract" | "final" | "public" )* f1 ->
	 * UnmodifiedClassDeclaration()
	 */
	public void visit(ClassDeclaration n);

	/**
	 * f0 -> "class" f1 -> <IDENTIFIER> f2 -> [ "extends" Name() ] f3 -> [
	 * "implements" NameList() ] f4 -> ClassBody()
	 */
	 ...
	 * "private" )* f1 -> UnmodifiedClassDeclaration()
	 */
	public void visit(NestedClassDeclaration n);

	/**
	 * f0 -> Initializer() | NestedClassDeclaration() |
	 * NestedInterfaceDeclaration() | ConstructorDeclaration() |
	 ...
	 * "final" | "native" | "synchronized" )* f1 -> ResultType() f2 ->
	 * <IDENTIFIER> f3 -> "("
	 */
	...
	/**
	 * f0 -> ( "static" | "abstract" | "final" | "public" | "protected" |
	 * "private" )* f1 -> UnmodifiedInterfaceDeclaration()
	 */
	public void visit(NestedInterfaceDeclaration n);

	/**
	 * f0 -> "interface" f1 -> <IDENTIFIER> f2 -> [ "extends" NameList() ] f3 ->
	 * "{" f4 -> ( InterfaceMemberDeclaration() )* f5 -> "}"
	 */
	public void visit(UnmodifiedInterfaceDeclaration n);

	/**
	 * f0 -> NestedClassDeclaration() | NestedInterfaceDeclaration() |
	 * MethodDeclaration() | FieldDeclaration()
	 */
	 ...
	 * "transient" | "volatile" )* f1 -> Type() f2 -> VariableDeclarator() f3 ->
	 * ( "," VariableDeclarator() )* f4 -> ";"
	 */
	...
	/**
	 * f0 -> [ "public" | "protected" | "private" ] f1 -> <IDENTIFIER> f2 ->
	...
	/**
	 * f0 -> "this" Arguments() ";" | [ PrimaryExpression() "." ] "super"
	 * Arguments() ";"
	 */
	...
	/**
	 * f0 -> Literal() | "this" | "super" "." <IDENTIFIER> | "(" Expression()
	 * ")" | AllocationExpression() | ResultType() "." "class" | Name()
	 */
	public void visit(PrimaryPrefix n);

	/**
	 * f0 -> "." "this" | "." AllocationExpression() | "[" Expression() "]" |
	 * "." <IDENTIFIER> | Arguments()
	 */
	public void visit(PrimarySuffix n);

	/**
	 * f0 -> <INTEGER_LITERAL> | <FLOATING_POINT_LITERAL> | <CHARACTER_LITERAL>
	...
	/**
	 * f0 -> "new" PrimitiveType() ArrayDimsAndInits() | "new" Name() (
	 * ArrayDimsAndInits() | Arguments() [ ClassBody() ] )
	 */
	...
	/**
	 * f0 -> LabeledStatement() | Block() | EmptyStatement() |
	...
	/**
	 * f0 -> [ "final" ] f1 -> Type() f2 -> VariableDeclarator() f3 -> ( ","
	 * VariableDeclarator() )*
	 */
	...
	/**
	 * f0 -> "for" f1 -> "(" f2 -> [ ForInit() ] f3 -> ";" f4 -> [ Expression()
	 * ] f5 -> ";" f6 -> [ ForUpdate() ] f7 -> ")" f8 -> Statement()
	 */
